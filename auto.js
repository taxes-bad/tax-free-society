...
var mainGameLoop = window.setInterval(function() {
  ...
  playerData.lastTick = Date.now(); // Don't forget to update lastTick.
  var offlineMoney = Math.round((playerData.AutoPrinters * (diff/1000))); // divide diff by how often (ms) mainGameLoop is ran
  playerData.money += offlineMoney;
  document.getElementById('modalText').innerHTML = offlineMoney;
  document.getElementById('TotalMoney').innerHTML = money;
}, 1000)
